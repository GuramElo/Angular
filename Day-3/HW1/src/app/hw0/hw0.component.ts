...
//@Output() public naClick:EventEmitter<{clicked:boolean}>=new EventEmitter<{clicked:boolean}>();

public  userEmit():void{

  //this.naClick.emit({clicked:true});
...
if((this.form.get("in2") as FormControl).value==(this.form.get("in3") as FormControl).value){
  (<HTMLInputElement>document.querySelector("form>input:nth-child(2)")).style.borderColor="lightGray";
}
else{
